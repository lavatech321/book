...
\begin{flushleft}
	...
	\begin{tcolorbox}[breakable,notitle,boxrule=1pt,colback=black,colframe=black]
		...
		\begin{enumerate}
			\item \textbf{Partitioning with fdisk}
			\item \textbf{Standard formatting filesystem}
			\item \textbf{Mounting partitions}
			\item \textbf{Managing /etc/fstab}
			\item \textbf{Setting up swap space}
		\end{enumerate}	
		\bigskip
